    ...
    <div className="min-h-screen bg-black text-white flex flex-col">
      ...
      <div className="flex flex-1 relative">
        ...
        <main className={`flex-1 flex items-center justify-center transition-all duration-300 pt-25 ${sidebarOpen ? 'ml-64' : '-ml-20'}`}>
          <div className="max-w-3xl w-full px-4 mt-16">


          <div className="text-left ml-10">
  <h1 className="text-4xl font-bold -mt-10 mb-1">Welcome founder.</h1>
  <p className="text-xl text-[#CAC5C5] mb-4">Introduce yourself</p>
</div>

            

            <form className="bg-[#151515] rounded-[20px] p-4 shadow-xl border border-[#1D1C1C] w-full max-w-2xl mx-auto">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-3">
                ...
                <div>
                  <label className="block text-lg font-semibold  text-[#CAC5C5]">Last Name</label>
                  <div className="border-b-[1px] border-[#1D1C1C]">
                    <input 
                      onChange={handleChange}
              ...
              <div className="mb-3">
                <label className="block text-lg font-semibold  text-[#CAC5C5]">City</label>
                <div className="border-b-[1px] border-[#1D1C1C]">
                  <input 
                    onChange={handleChange}
                    value={formData.city}
            ...
            <div className="flex justify-end mr-9 mt-6">
              <button 
                className="bg-white text-black font-bold py-2 px-16   rounded-[10px] text-lg" 
                onClick={() => navigate("/putaface")}
              >
                Continue
              </button>
            </div>
