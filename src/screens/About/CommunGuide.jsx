        ...
        <main className="overflow-y-scroll pt-12 h-full scrollbar-hide">
          <div className="bg-black text-gray-300 min-h-screen flex flex-col">
            <div className="flex justify-end">
              <button
                onClick={() => navigate(-1)}
                className="mr-2 fixed z-50 transition ease-in-out duration-300 hover:scale-110"
                >
            ...
            <main className="flex flex-col w-full mx-auto px-6 max-sm:px-4">
              <h1 className="text-4xl max-sm:text-2xl font-bold text-white text-center mb-8">Community Guidelines</h1>
              <p className="text-gray-400 mb-6 max-sm:text-sm text-center">
                Community Guidelines & Support of Vertex Labs.
              </p>
