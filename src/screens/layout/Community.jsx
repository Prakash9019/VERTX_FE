  ...
  return (
    <Layout sidebarOpen={sidebarOpen} setSidebarOpen={setSidebarOpen}>
      <div className="flex flex-col min-h-screen">
        <div className={`${isMobile ? 'px-4 -mt-5 pb-24 flex-grow' : 'w-full px-4 mx-auto '} overflow-y-auto`}>
          <div className="text-white">
            ...
            <main className="flex-1 ">
              ...
              <div className="container mx-auto">
                <h1 className="text-4xl md:text-4xl mb-6 font-bold">Community</h1>
              </div>
            </header>
                {/* Newsletter Section */}
...
>
  ...
  />
                  ...
                  <p className="text-center text-[#FBFAF4] text-[15px] max-w-lg mx-auto">
                    ...
                    <br className="hidden md:block" /> founder digest every Tuesday for free.
                  </p>
                </div>
                ...
                <div className="flex justify-center space-x-6 mb-12">
                  {/* LinkedIn */}
                  <a href="https://www.linkedin.com/company/govertx/ " className="text-white">
                  ...
                  <a href="hello@govertx.com" className="text-white">
                    <svg width="40" viewBox="0 0 28 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <g clipPath="url(#clip0_2948_589)">
                        <path d="M1.90909 21H6.36364V10.1818L0 5.40906V19.0909C0 20.1472 0.855909 21 1.90909 21Z" fill="white"/>
                        <path d="M21.6364 21H26.0909C27.1473 21 28 20.1441 28 19.0909V5.40906L21.6364 10.1818" fill="#FBFAF4"/>
                        <path d="M21.6364 1.90914V10.1819L28 5.40914V2.86368C28 0.502772 25.305 -0.843137 23.4182 0.572772" fill="#1F1F1F"/>
                        <path d="M6.36365 10.1818V1.90906L14 7.63633L21.6364 1.90906V10.1818L14 15.9091" fill="#4B4B4B"/>
                        <path d="M0 2.86368V5.40914L6.36364 10.1819V1.90914L4.58182 0.572772C2.69182 -0.843137 0 0.502772 0 2.86368Z" fill="#1F1F1F"/>
                      </g>
                      <defs>
                  ...
                  {/* WhatsApp */}
                  <a href="https://chat.whatsapp.com/B5G68k1ipkO95OnQusvIq8 " className="text-white">
                    <svg className="w-8 h-8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  {/* Instagram */}
                  <a href="https://www.instagram.com/vertx4founders/ " className="text-white">
                    <svg className="w-8 h-8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
