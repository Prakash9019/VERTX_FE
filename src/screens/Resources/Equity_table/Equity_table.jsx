...
export default function EquityCalculator({ onClose }) {
  const [founders, setFounders] = useState([
    { id: "1", name: "Co-founder A", percentage: 0, checks: 0 },
    { id: "2", name: "Co-founder B", percentage: 0, checks: 0 },
  ])
  ...
  const updateFounderName = (id, newName) => {
    setFounders(founders.map(f => f.id === id ? { ...f, name: newName } : f))
  }
          ...
          <div className="faqs-container">
            {faqs.map((faq, index) => (
              <div key={index} className="faq-item">
                <div className="faq-question" style={{ fontSize: "0.95rem" }}>
                  {faq.question}
                </div>
                <div className="faq-answer" style={{ fontSize: "0.95rem" }}>
                  {faq.answer}
                </div>
              </div>
            ))}
