...
export default function EquityCalculator() {
  ...
  // Define colors for the equity bars
  const BAR_COLORS = ['#000000', '#444444'];
          ...
          <div className="content-wrapper">
            ...
            <div>
              <div className="section-header">
                <h1 className="page-title">Equity and Cap Table Management</h1>
              ...
              <div className="definitions-section">
                ...
                <div className="definitions-table-container">
                  <table className="definitions-table">
                    <thead>
                      <tr>
                        <th className="th-term">Term</th>
                        <th className="th-case">Case</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr className="table-row-bordered">
                        <td className="td-term">Founder Equity</td>
                        <td className="td-case">The ownership stake of the startup's original founders.</td>
                      </tr>
                      <tr className="table-row-bordered">
                        <td className="td-term">Dilution</td>
                        <td className="td-case">The decrease in existing shareholders' ownership when new shares are issued.</td>
                      </tr>
                      <tr className="table-row-bordered">
                        <td className="td-term">Stock Options (ESOPs)</td>
                        <td className="td-case">Shares reserved for employees as part of compensation.</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
              ...
              <div className="calculator-section">
                <h2 className="section-title">Founder equity calculator</h2>
                          ...
                          <thead>
                            <tr>
                              ...
                              {founders.map(founder => (
                                <th key={founder.id} className="th-founder">{founder.name}</th>
                              ))}
                            </tr>
                          </thead>
                          <tbody>
                        ...
                        {founders.map((founder, idx) => (
                          <div key={founder.id} className="founder-equity-item">
                            <div className="founder-equity-header">
                              ...
                              <span className="founder-percentage">{founder.percentage}%</span>
                            </div>
